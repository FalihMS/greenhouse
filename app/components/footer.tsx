      ...
      <footer className="bg-white">
        <div className="mx-auto max-w-screen px-4 pb-8 pt-16 sm:px-6 lg:px-8 lg:pt-24">
          <div className="text-center">
            <h2 className="text-3xl font-extrabold text-gray-900 sm:text-5xl">Dapatkan penawaran spesial!</h2>
  
            <p className="mx-auto mt-4 max-w-lg text-gray-500">
            Jangan lewatkan kesempatan ini untuk mendapatkan produk hidroponik berkualitas tinggi dengan harga spesial!
            </p>
          ...
          >
            <ul className="flex flex-wrap justify-center gap-4 text-xs lg:justify-end">
              <li>
                <a href="#" className="text-gray-500 transition hover:text-lime-500"> Terms & Conditions </a>
              </li>
  
              <li>
                <a href="#" className="text-gray-500 transition hover:text-lime-500"> Privacy Policy </a>
              </li>
  
              <li>
                <a href="#" className="text-gray-500 transition hover:text-lime-500"> FAQ </a>
              </li>
            </ul>
